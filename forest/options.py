...
def options():
    ...
    parser.add_argument('--dataset', default='CIFAR10', type=str, choices=['CIFAR10', 'CIFAR100', 'ImageNet', 'ImageNet1k',
                                                                           'MNIST', 'TinyImageNet', 'GTSRB'])
    parser.add_argument('--recipe', default='gradient-matching', type=str, choices=['gradient-matching', 'gradient-matching-private', 'gradient-matching-mt',
                                                                                    ...
                                                                                    'diffusion-poison', 'diffusion-poison-dot-product'])
    ...
    parser.add_argument('--num_steps', default=3, type=int, help='recurrent steps')
    parser.add_argument('--optim_guidance_3_wt', default=50, type=float, help='guidence coefficient')
    parser.add_argument('--matching_loss_w', default=1.0, type=float, help='Matching loss weight')
    parser.add_argument('--poison_loss_w', default=0, type=float, help='Poison loss weight')
    parser.add_argument('--diffusion_model', default='regular', type=str, choices=['regular'])
    parser.add_argument('--num_poisons', default=50, type=int, help='number of poisons in diffusion poisoning')
    parser.add_argument('--diffusion_base_poisons', action='store_true', help='Create Base poisons for diffusion')
    parser.add_argument('--print_diff_stats', action='store_true', help='Print diffusion process stats')
    parser.add_argument('--base_num_steps', default=5, type=int, help='recurrent steps for base poisons')
    parser.add_argument('--base_optim_guidance_3_wt', default=5, type=float, help='guidance coefficient for base poisons')
    parser.add_argument('--base_matching_loss_w', default=0.5, type=float, help='Matching loss weight')
    parser.add_argument('--base_poison_loss_w', default=10, type=float, help='Poison loss weight')
    parser.add_argument('--base_diffusion_model', default='regular', type=str, help='Base Diffusion type')
    parser.add_argument('--filter_max_matching', action='store_true', help='Filter poisons based on gradient matchong')
    parser.add_argument('--load_poisons', default=None, type=str, help='Path to poisons')
    parser.add_argument('--nonormalize', action='store_true', help='Disable data normalization')
    parser.add_argument('--bpaugment', action='store_false', help='Do not augment poison batch during diffusion process')
